...
import styles from "./whatssappbtn.module.css";
  ...
  return (
    <div className={styles["whatsapp-container"]}>
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className={styles["whatsapp-motion-wrapper"]}
      >
        <a
          href={`https://wa.me/${telefono}?text=${mensaje}`}
          target="_blank"
          className="bg-[#25D366] p-4 rounded-full flex items-center shadow-2xl"
        >
          <svg
            ...
            fill="#ffce00"
          >
            <g clip-path="url(#clip0_4418_6554)">
              <path
            ...
            <defs>
              <clipPath id="clip0_4418_6554">
                <rect width="50" height="50" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <span className={styles["btn-text"]}>whatsapp</span>
        </a>
      </motion.div>
    </div>
  );
